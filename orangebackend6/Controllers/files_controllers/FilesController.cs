...
public class StorageController : ControllerBase
{
    ...
    [HttpPost("uploadInstituto")]
    public async Task<IActionResult> uploadInstituto()
    {
        try
        {
            var file = _httpContextAccessor.HttpContext.Request.Form.Files[0];
            ...
            if (file.Length > 0)
            {
                ...
                var storagePath = Path.Combine(_hostingEnvironment.WebRootPath, "instituto");
                ...
                // Puedes devolver la URL del archivo como respuesta.
                var fileUrl = $"/instituto/{fileName}";
