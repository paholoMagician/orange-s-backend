...
namespace orangebackend6.Models
{
    public partial class orangeContext
    {
        ...
        protected void OnModelCreatingGeneratedProcedures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ObtenerModulosResult>().HasNoKey().ToView(null);
        }
    }
    ...
    public partial class orangeContextProcedures : IorangeContextProcedures
    {
        ...
        public virtual async Task<int> actualizarImgInstitutoAsync(string url, int? idintituto, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ParameterName = "idintituto",
                    Value = idintituto ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[actualizarImgInstituto] @url, @idintituto", sqlParameters, cancellationToken);
        ...
        public virtual async Task<int> actualizarImgPerfilAsync(string url, string coduser, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[actualizarImgPerfil] @url, @coduser", sqlParameters, cancellationToken);
        ...
        public virtual async Task<int> CambiarEstadoCommentsAsync(int? codcomments, int? estado, string codusereact, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ParameterName = "codusereact",
                    Size = 30,
                    Value = codusereact ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.VarChar,
                },
                parameterreturnValue,
            };
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[CambiarEstadoComments] @codcomments, @estado, @codusereact", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerModulosResult>> ObtenerModulosAsync(string usCod, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "usCod",
                    Size = 30,
                    Value = usCod ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.VarChar,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<ObtenerModulosResult>("EXEC @returnValue = [dbo].[ObtenerModulos] @usCod", sqlParameters, cancellationToken);
