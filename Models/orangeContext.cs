...
namespace orangebackend6.Models
{
    public partial class orangeContext : DbContext
    {
        ...
        public virtual DbSet<Intituto> Intituto { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Direcciones>(entity =>
            {
                ...
                entity.Property(e => e.Idinstituto).HasColumnName("idinstituto");
            ...
            modelBuilder.Entity<Intituto>(entity =>
            {
                entity.HasKey(e => e.Idintituto);

                entity.ToTable("intituto");

                entity.Property(e => e.Idintituto).HasColumnName("idintituto");
                ...
                entity.Property(e => e.Logtipourl)
                    .HasMaxLength(200)
                    .IsUnicode(false)
                    .HasColumnName("logtipourl");
            ...
            modelBuilder.Entity<Perfil>(entity =>
            {
                ...
                entity.Property(e => e.FotoperfilA)
                    .HasMaxLength(300)
                    .IsUnicode(false)
                    .HasColumnName("fotoperfilA");

                entity.Property(e => e.FotoperfilB)
                    .HasMaxLength(300)
                    .IsUnicode(false)
                    .HasColumnName("fotoperfilB");

                entity.Property(e => e.FotoperfilC)
                    .HasMaxLength(300)
                    .IsUnicode(false)
                    .HasColumnName("fotoperfilC");
